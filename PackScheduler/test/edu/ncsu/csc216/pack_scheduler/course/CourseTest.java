...
public class CourseTest {
	...
	public void testShortDisplayArray() {
		...
		assertEquals(NAME, c.getShortDisplayArray()[0]);
	}
	
	/**
	 * Tests the long display array
	 */
	@Test
	public void testLongDisplayArray() {
		Activity c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
		assertEquals(NAME, c.getLongDisplayArray()[0]);
	}
